...
namespace daolibrary.Migrations
{
    ...
    [Migration("20241023140858_CambioEnTodoElRepoPostPorSong")]
    partial class CambioEnTodoElRepoPostPorSong
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("entities_library.song.Song", b =>
                {
                    b.Property<long>("SongId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("entities_library.billboard.Billboard", b =>
                {
                    b.HasOne("entities_library.song.Song", "song")
                        .WithOne("Billboard")
                        .HasForeignKey("entities_library.billboard.Billboard", "SongId")
            ...
            modelBuilder.Entity("entities_library.comment.Comment", b =>
                {
                    b.HasOne("entities_library.song.Song", null)
                        .WithMany("Comments")
